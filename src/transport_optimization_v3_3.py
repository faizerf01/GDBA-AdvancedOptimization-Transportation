...
"""
Optimization Script - Version 3.3
Objective: Prioritize delivery speed
Weights: Cost α = 0.3, Time β = 0.7
"""
...
# Build model
model = LpProblem("Transport_Optimization_v3_3", LpMinimize)
...
pd.DataFrame(results).to_excel("optimized_transport_plan_v3_3.xlsx", index=False)
pd.DataFrame(unmet_summary).to_excel("unmet_demand_report_v3_3.xlsx", index=False)
print("Results saved.")
