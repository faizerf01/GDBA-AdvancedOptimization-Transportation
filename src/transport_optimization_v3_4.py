...
"""
Optimization Script - Version 3.4
Objective: Balance cost and speed equally
...
# Build model
model = LpProblem("Transport_Optimization_v3_4", LpMinimize)
...
pd.DataFrame(results).to_excel("optimized_transport_plan_v3_4.xlsx", index=False)
pd.DataFrame(unmet_summary).to_excel("unmet_demand_report_v3_4.xlsx", index=False)
print("Results saved.")
